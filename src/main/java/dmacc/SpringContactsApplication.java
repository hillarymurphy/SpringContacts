...
/*		ApplicationContext appContext = new AnnotationConfigApplicationContext(BeanConfiguration.class);
	 ...
	 * Auto-generated method stub ApplicationContext appContext = new
	 * AnnotationConfigApplicationContext(BeanConfiguration.class);
	 * 
	 * //Using an existing bean Contact c =
	 * appContext.getBean("contact",Contact.class);
	 * c.setRelationship("best friend"); repo.save(c);
	 * 
	 * //Creating a bean to use – not managed by Spring Contact d = new
	 * Contact("John Doe", "555-555-9997", "Cousin"); Address a = new
	 * Address("123 Main Street", "Des Moines", "IA"); d.setAddress(a);
	 * repo.save(d);
	 * 
